...
public class LoginScreenController {
  ...
  @FXML private PasswordField password; // Change from TextField to PasswordField

  @FXML private Button next_button;

  public void NextButton(ActionEvent event) throws SQLException {
  ...
  public static boolean ValidatemobileAndpassword(String mobile_number, String password)
    ...
    try {
      ...
      if (response.getStatus().equals("Login Successfully!!")) {
        return true;
      }
    } catch (Exception e) {
      e.printStackTrace();
